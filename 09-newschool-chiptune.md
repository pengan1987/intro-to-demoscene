...
The "second generation" or "new school" chip musicians mentioned in "Geeks on Stage" are probably closer to how we think of chip music today, at least in the sense that many of the software they use is the one that comes up most frequently when we refer to chip music today, such as LSDJ and FamiTracker, to name a few. And there are many differences between them and the demoscene, both in terms of community culture and practice characteristics.
...
From the 1980s to the 1990s, chip music developed a range of software, tools and methods from the demoscene. However, the most important hallmark of chip music from the late 1990s to around 2000 was the "exodus" from the demoscene and the incorporation of more pop music features, a period when the chip music scene focused on sound beyond hardware, and an extreme of this attempt was "sound without hardware". As the name "Cubase chip musicians" describes, "fake chip" musicians used a lot of digital audio workstation (DAW) software for their productions, not necessarily using real sound chips, and often did not understand the programmable nature of sound chips.

The emergence of "fake chips" among the second generation of chip musicians is probably the most controversial topic in the chip music world today, and the controversy continues to this day, but among the "third generation" of chip musicians to be introduced later, "Fake Chip" has a higher degree of acceptance than any previous generation of participants.
...
For myself, I have personally experienced such a process of imitating and then being imitated. FutureSound Vol.2, which I participated in Beijing in the summer of 2019, was a workshop on chip music production, and its main content, imitated from the ChipLabs workshop of the Vancouver Chip Music Society.

## Global Music Festival
The second generation of chip musicians mentioned in "Chipmusic, Fakebit and the Discourse of Authenticity in the Chipscene" are also the main group who established many global chip music festivals, and also play a major role in the popularization of chip music to the masses:.
...
And Japanese demoscene and chip music researcher, SID Media Lab station webmaster Takashi Kawano(akaobi) [mentioned](https://akaobi.wordpress.com/2015/07/01/anti-memoirs-an-experience-of-chipmusic-in-japan/) that in the 90's Japanese Tracker used to make BMS files for music game BM98, and "MOD" was once mistaken as a synonym for game files. He also mentions that VORC was the first website to introduce the term "chip music" to Japan.
...
The year 2002 is considered by hally to be "[the real beginning of chip music in Japan](http://www.vorc.org/en/columns/hally/2002best10e.html)", and much of that revolved around LSDJ.
