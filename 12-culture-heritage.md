...
Looking further into the definition of ICH in the [Convention for the Safeguarding of the Intangible Cultural Heritage](https://unesdoc.unesco.org/ark:/48223/pf0000132540), we can see that the Convention does not emphasize "long history", but rather adaptation and interaction with the environment, and "constantly recreated".
